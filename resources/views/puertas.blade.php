                        ...
                        <table class="table table-sm table-bordered" id="puertas">
                            <thead class="text-center">
                                <tr class="color-line line-objetos">
                                    ...
                                    <th style="text-align: center">Estacion / Terminal</th>
                                    <th style="text-align: center">Vía</th>
                                    <th style="text-align: center">Descripción</th>
                                    <th style="text-align: center">Puerta Opuesta</th>
                                    <th style="text-align: center">Desalojo</th>
                                    <th style="text-align: center">Asistencia Policia</th>
